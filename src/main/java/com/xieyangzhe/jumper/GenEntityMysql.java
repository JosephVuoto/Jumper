...
public class GenEntityMysql {
    ...
    private static final String URL = "jdbc:mysql://localhost:3306/jumper?useUnicode=true&characterEncoding=utf-8";
    ...
    private String packageOutPath = "com.xieyangzhe.model";// 指定实体生成所在包的路径
    private String authorName = "joseph";// 作者名字
    private String[] generateTables = new String[]{"url_mapper"};
